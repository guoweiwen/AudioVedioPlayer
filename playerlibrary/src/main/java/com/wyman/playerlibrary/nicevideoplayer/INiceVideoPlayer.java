 ...
 * Created by wyman
 * on 2018-09-07.
 * 将MediaPlayer的方法抽象出来；实现多态，以后不一定用MediaPlayer
 * 可以用其他MediaPlayer
 */
public interface INiceVideoPlayer {
     ...
     * 开始播放时，是否从上一次的位置继续播放
     *
     * @param continueFromLastPosition true
     *                                 接着上次的位置继续播放，false重头开始播放
     */
